# [SOLVED] Catching-An-Exception-While-Using-A-Python-39-With-39-Statem
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/catching-an-exception-while-using-a-python-39-with-39-statem)
>
...
Use the 'try' and 'except' blocks outside the 'with' statement to catch the FileNotFoundError, e.g. try: with open('a.txt') as f: print(f.readlines()) except FileNotFoundError: print('File not found')
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/catching-an-exception-while-using-a-python-39-with-39-statem)**
